...
public class Lukesprite implements Drawable {
    ...
    /*
        LukeSprite Konstruktor
     */

    public Lukesprite(GameContent gameContent, Bitmap bmp) {
    ...
    /*
        Transformation der Matrix der Bitmap
     */
    @Override
    public void draw(Canvas canvas) {
        ...
        Rect dst = new Rect(x,y,x+width-55, y+height-55); // Skaliert Bild zu diesen Maßen - Skalierendes Rechteck
